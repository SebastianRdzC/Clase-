        ...
        <>
            <div className='flex  items-center h-screen w-screen relative font-[Montserrat] bg-[#fff] overflow-hidden'>
                ...
                <div className='w-full h-full flex justify-center items-center'>
                    ...
                    <div className='absolute top-4 left-4 z-20 cursor-pointer hover:scale-110 transition-transform duration-200 
                        ...
                        onClick={() => navigate('/')}
                        >
                        <ChevronLeft className="sm:w-5 md:w-5" color='white' width={20} />
                    ...
                    <div className=' z-0 text-white h-auto w-120 flex flex-col justify-start p-12 gap-5 rounded-xl relative'>
                        ...
                        <div className='z-1 flex flex-col justify-between items-center w-full gap-4'>
                            ...
                            />
                            <h1 className='inline-flex text-3xl  z-1 tracking-wider text-white text-center'>
                                Bienvenido de vuelta
                            </h1>
                            <span className='text-sm inline-flex z-1 text-white/60 text-center'>
